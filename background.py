...
async def process_channel_ads_broadcast():
    ...
    try:
        ...
        for ad in due_ads:
            ...
            try:
                await bot_inst.copy_message(chat_id=c_id, from_chat_id=f_chat_id, message_id=m_id)
...
# YEH NAYA FUNCTION ADD KAREIN
    ...
    async def handle_conv_channel_ad_add_channel(self, state):
        ...
        try:
            test_msg = await clone_bot.send_message(channel_id, "🔔 Checking ad broadcast permission...")
