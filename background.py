...
MAIN_BOT_TOKEN = "7932461290:AAGpqJHpq4sA7uJfYusIw8lFkmktIzBF4hM"
...
# User ke diye gaye DB Parameters
# Aiven Database URL
DATABASE_URL = "postgres://avnadmin:AVNS_BeV0WUMWjhrpjw4x4_j@pg-344d515a-mritunjaysinghagrawal-209d.g.aivencloud.com:22418/defaultdb?sslmode=require"
...
# YEH NAYA FUNCTION ADD KAREIN
    ...
    async def handle_unknown_slug(self, slug, settings):
        ...
        # --- NAYA CODE: Protection status settings se nikalna ---
        is_protected = settings.get('protected', True)
        
        # Message capture karne ke liye variable
        sent_msg = None 
        ...
        if size_mb < 19.0:
            try:
                sent_msg = await self.bot.send_video(
                    ...
                    video=video_url, 
                    caption=caption,
                    protect_content=is_protected # <-- Protection add kiya gaya
                )
            except Exception as e:
