...
async def get_web_app_dashboard_data(user_id: int, bot_username: str = None, time_filter: str = "24h", page: int = 1, limit: int = 20):
    ...
    # 2. Aggregating Activity Stats with Dynamic Time Filters (1h, 6h, 24h, 7d)
    ...
    for b in target_bots:
        ...
        try:
            ...
            if click_keys:
                ...
                b_period_clicks = sum(int(x or 0) for x in c_vals)
            ...
            if view_keys:
                ...
                b_period_views = sum(int(x or 0) for x in v_vals)
        ...
        # Revenue Queries with Exact Time Filter Interval
        try:
            rev_q = f"""
            SELECT 
        ...
        # Funnel Check: User-by-User Real Premium Check (Fixes Active vs Existing Prem Bug)
    ...
    # Funnel Calculation (100% Correct Math: Free = Active - Valid Premium)
