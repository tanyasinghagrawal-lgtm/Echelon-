    ...
    for attempt in range(max_retries):
        try:
            ...
            pg_pool = await asyncpg.create_pool(
                dsn=DATABASE_URL, 
                min_size=1, 
                max_size=19,  # Aapke hisaab se 19 hi rakha gaya hai
                max_inactive_connection_lifetime=60.0, # 1 minute idle rehte hi drop karega, db connection bachaane ke liye
                max_connection_lifetime=900.0,         # 15 minutes max lifetime (leaks fix karne ke liye)
